...
#首先构建语料库
def saveCorpos(corposPath='corpos.xlsx'):
    filePaths = []
    fileContents = []
    ...
    corpos.to_excel(corposPath,encoding='utf-8')

corposPath='corpos.xlsx'
saveCorpos(corposPath)
corpos=pandas.read_excel(corposPath)
